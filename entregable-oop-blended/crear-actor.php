...
?>
		...
		<div class="container">
						...
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									<label>Nombre:</label>
									<input type="text" class="form-control" placeholder="Ej: Juan" name="first_name">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<label>Apellido:</label>
									<input type="text" class="form-control" placeholder="Ej: Perez" name="last_name">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<select class="form-control" name="favorite_movie_id">
										<option value="">Elegí la pelicula</option>
			...
			<?php if (isset($saved)): ?>
				...
				>
					<?php echo $saved ? '¡Actor guardodo con éxito!' : '¡No se pudo guardar el actor!' ?>
				</div>
			<?php endif; ?>
		</div>
	</body>
